...
namespace Test.IrcDotNet
{
    ...
    [TestClass]
    public class IrcClientTestSetUWP
    {
...
#pragma warning restore 0649
        ...
        public void ClassInitialize()
        {
            ...
            serverPassword = App.GetString("ServerPassword");
            if (string.IsNullOrEmpty(serverPassword))
                serverPassword = null;
            nickName1 = userName1 = string.Format(App.GetString("NickNameFormat"), getRandomUserId());
            nickName2 = userName2 = string.Format(App.GetString("NickNameFormat"), getRandomUserId());
            realName = App.GetString("RealName");
            ...
            ircClient1.Connect(App.GetString("ServerHostName"), false, new IrcUserRegistrationInfo()
                {
            ...
            ircClient2.Connect(App.GetString("ServerHostName"), false, new IrcUserRegistrationInfo()
                {
                    Password = serverPassword,
                    NickName = nickName2,
                    UserName = userName2,
        ...
        private static IEnumerable<FieldInfo> GetAllWaitHandlesFields()
        {
            ...
            return typeof(IrcClientTestSetUWP).GetFields(BindingFlags.Static | BindingFlags.NonPublic)
        ...
        {
            if (!client2ErrorEvent.GetSafeWaitHandle().IsClosed)
            {
        ...
        {
            Debug.Assert(false, string.Format(App.GetString("MessageProtocolError"),
