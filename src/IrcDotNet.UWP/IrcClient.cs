    ...
    public abstract partial class IrcClient : IDisposable
    {
        ...
        protected bool HandleISupportParameter(string paramName, string paramValue)
        {
            ...
            if (paramName.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "paramName");
            ...
            switch (paramName.ToLowerInvariant())
            {
                case "prefix":
                    ...
                    if (prefixes.Length != modes.Length)
                        throw new ProtocolViolationException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageISupportPrefixInvalid"));
        ...
        protected Tuple<string, string> GetUserModeAndNickName(string input)
        {
            ...
            if (input.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "input");
            ...
            switch (type)
            {
                ...
                default:
                    throw new ArgumentException(string.Format(
                        ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidChannelType"), type), "type");
            }
        }
        ...
        protected IIrcMessageTarget GetMessageTarget(string targetName)
        {
            ...
            if (targetName.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "targetName");
            ...
            {
                throw new ArgumentException(string.Format(
                    ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidSource"), targetName), "targetName");
            }
        }
        ...
        protected IIrcMessageSource GetSourceFromPrefix(string prefix)
        {
            if (prefix == null)
                return null;
            if (prefix.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "prefix");
            ...
            {
                throw new ArgumentException(string.Format(
                    ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidSource"), prefix), "prefix");
            }
        }
        ...
        protected IrcServer GetServerFromHostName(string hostName, out bool createdNew)
        {
            ...
            if (hostName.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "hostName");
        ...
        protected IrcChannel GetChannelFromName(string channelName, out bool createdNew)
        {
            ...
            if (channelName.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "channelName");
        ...
        protected IrcUser GetUserFromNickName(string nickName, bool isOnline, out bool createdNew)
        {
            ...
            if (nickName.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "nickName");
        ...
        protected IrcUser GetUserFromUserName(string userName, out bool createdNew)
        {
            ...
            if (userName.Length == 0)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageValueCannotBeEmptyString"), "userName");
            ...
            foreach (var method in this.GetAttributedMethods<MessageProcessorAttribute, MessageProcessor>())
            {
                ...
                else
                {
                    throw new ProtocolViolationException(string.Format(
                        ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidCommandDefinition"), attribute.CommandName));
                }
            };
        }
        ...
        protected void WriteMessage(IrcMessage message)
        {
            ...
            if (message.Command == null)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidCommand"), "message");
            if (message.Parameters.Count > maxParamsCount)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageTooManyParams"), "parameters");
        ...
        private string CheckPrefix(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(
                    ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidPrefix"), value), "value");
            }
        ...
        private string CheckCommand(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(
                    ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidCommand"), value), "value");
            }
        ...
        private string CheckMiddleParameter(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(
                    ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidMiddleParameter"), value), "value");
            }
        ...
        protected void CheckRegistrationInfo(IrcRegistrationInfo registrationInfo, string registrationInfoParamName)
        {
            ...
            if (registrationInfo is IrcUserRegistrationInfo)
            {
                if (registrationInfo.NickName == null ||
                    ...
                    throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidUserRegistrationInfo"),
            ...
            else if (registrationInfo is IrcServiceRegistrationInfo)
            {
                if (registrationInfo.NickName == null ||
                    ...
                    throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidServiceRegistrationInfo"),
                        registrationInfoParamName);
            }
            else
            {
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageInvalidRegistrationInfoObject"),
                    registrationInfoParamName);
            }
        }
