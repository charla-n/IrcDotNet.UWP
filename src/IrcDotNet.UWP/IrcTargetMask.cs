...
namespace IrcDotNet
{
    ...
    public class IrcTargetMask : IIrcMessageTarget
    {
        ...
        public IrcTargetMask(string targetMask)
        {
            ...
            if (ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageTargetMaskTooShort").Length < 2)
                throw new ArgumentException(ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageTargetMaskTooShort"), "targetMask");
            ...
            if (targetMask[0] == '$')
                ...
                throw new ArgumentException(string.Format(
                    ResourceLoader.GetForCurrentView("IrcDotNetUWPResources").GetString("MessageTargetMaskInvalidType"), targetMask), "targetMask");
